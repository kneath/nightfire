...
objConn.ConnectionString="Provider=SQLOLEDB;User ID=sa;Password=Kt6261;Initial Catalog=warpspire"
...
%>
<frameset cols='150, *' border=0 bordercolor='#000000'>
<frame src='side.asp' name='sidebar'>
<frame src='main.asp' name='main'>
</frameset>
<noframes>
Your browser must support frames to play this game.
</noframes>
<%
END IF
